    ...
    internal class Program
    {
        internal static void Main(string[] args)
        {
            ...
            void StartTeamFlow(string userName, string dataDatetimeMinusWeek, string dataDateTime)
            {
                ...
                Entry.CalculateBestPlayerStats(playerList, teamPlayerList, dataDatetimeMinusWeek, dataDateTime);
                ...
                ShowTeamData(userName, userPlayerTeams, dataDateTime, dataDatetimeMinusWeek);
            ...
            void ShowTeamData(string userName, List<Team> teams, string dateTime, string dateTimeMinusWeek)
            {
                var playerList = Entry.LoadPlayerData();
                ...
                {
                    EditTeams(userName,teams, playerList, addOrRemove,  dateTime,dateTimeMinusWeek);
                }

            }


            void EditTeams(string userName, List<Team> teams, List<Player> players, string addOrRemove, string dateTime, string dateTimeMinusWeek)
            {
                ...
                if (addOrRemove == "ADD")
                {
                    ...
                    ShowTeamData(userName, teams, dateTime, dateTimeMinusWeek);
                }
